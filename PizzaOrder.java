		...
		for(int i =0; i < 10; i ++){
			...
			switch(choice){
				...
				case '2':					
					...
					printMenu();	
					input = keyboard.nextLine().trim();
				choice = input.charAt(0);				// view order info
					break;
	...
	*/
	public static int getTotalCost(String[] orders){
		...
		for(int i = 0; i < orders.length; i++){
			if(orders[i] != null){
				String[] costNumTwo = orders[i].split(":");
				String cost = costNumTwo[1];
...
// TASK-8: Current Date
	...
	*/
	public static void printCurrentDate(){
		...
		System.out.print(subs[2] + "." + subs[1] + "." + subs[0]);  
	} 
...
// TASK-9: Current Time
	...
	*/
	public static void printCurrentTime(){
		String[] time = (java.time.LocalTime.now()+"").split(":");
